...
interface ForageableDao {
    ...
    // TO DO: implement a method to retrieve all Forageables from the database
    @Query("SELECT * from forageable_database WHERE id = :id")
    fun getForageable(id: Long): Flow<Forageable>

    // TO DO: implement a method to retrieve a Forageable from the database by id
    @Query("SELECT * from forageable_database ORDER BY name ASC")
    fun getForageables(): Flow<List<Forageable>>

    // TO DO: implement a method to insert a Forageable into the database
    //  (use OnConflictStrategy.REPLACE)
    @Insert(onConflict = OnConflictStrategy.REPLACE)
    suspend fun insert(forageable: Forageable)

    // TO DO: implement a method to update a Forageable that is already in the database
    @Update
    suspend fun update(forageable: Forageable)

    // TO DO: implement a method to delete a Forageable from the database.
    @Delete
